...
public class CustomTitleBar extends LinearLayout implements View.OnClickListener {
    ...
    private void init(final Context context) {
        ...
        textCenter.setTextSize(TypedValue.COMPLEX_UNIT_SP,19);
        ...
        textRight.setTextSize(TypedValue.COMPLEX_UNIT_SP,18);
        ...
        switch (v.getId()) {
            case R.id.backLayout:
                if (onTitleBarClickListener != null) {
                     if (onTitleBarClickListener.OnBackImageClick()){ // 已处理
