package com.meishe.paintbrush.selectmedia.fragment;
...
import com.meishe.paintbrush.base.BaseFragment;
import com.meishe.paintbrush.selectmedia.SelectMediaActivity;
import com.meishe.paintbrush.selectmedia.adapter.AgendaSimpleSectionAdapter;
import com.meishe.paintbrush.selectmedia.adapter.SectionedSpanSizeLookup;
...
import com.meishe.paintbrush.utils.MediaUtils;
...
public class MediaFragment extends BaseFragment implements OnTotalNumChange {
    ...
    protected void initArguments(Bundle arguments) {
        if (arguments != null) {
            ...
            mLimitMediaCount = arguments.getInt("limitMediaCount", -1);
        }
    }
    ...
    private void showLocalMediaByMediaType() {
        ...
        MediaUtils.getMediasByType(mActivity, index, new MediaUtils.LocalMediaCallback() {
            ...
            public void onLocalMediaCallback(final List<MediaData> allMediaTemp) {
                ...
                adapter = new AgendaSimpleSectionAdapter(lists, listOfOut, mediaRecycler, MediaFragment.this, index, mActivity,clickType,mLimitMediaCount);
