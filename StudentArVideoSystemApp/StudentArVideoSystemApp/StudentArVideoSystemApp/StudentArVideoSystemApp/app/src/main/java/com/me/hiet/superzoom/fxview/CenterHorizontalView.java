package com.me.hiet.superzoom.fxview;
...
public class CenterHorizontalView extends RecyclerView {
    ...
    /**
     * 设置初始化时选中的位置,该方法必须在{@link CenterHorizontalView#setAdapter(android.support.v7.widget.RecyclerView.Adapter) }之前调用
     *
    ...
    /**
     * 设置每次显示多少个item,该方法必须在{@link CenterHorizontalView#setAdapter(android.support.v7.widget.RecyclerView.Adapter) }之前调用
     *
