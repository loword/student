package com.me.hiet.capturescene;
...
import com.me.hiet.MainActivity;
...
import com.me.hiet.capturescene.adapter.CaptureSceneAdapter;
import com.me.hiet.capturescene.data.CaptureSceneOnlineData;
import com.me.hiet.capturescene.data.Constants;
import com.me.hiet.capturescene.httputils.NetWorkUtil;
import com.me.hiet.capturescene.httputils.OkHttpClientManager;
import com.me.hiet.capturescene.httputils.ResultCallback;
import com.me.hiet.capturescene.httputils.download.DownLoadResultCallBack;
import com.me.hiet.capturescene.interfaces.OnItemClickListener;
import com.me.hiet.capturescene.view.CircleBarView;
...
import com.me.hiet.utils.PathNameUtil;
import com.me.hiet.utils.PathUtils;
import com.me.hiet.utils.PopWindowUtil;
import com.me.hiet.utils.SpUtil;
import com.me.hiet.utils.TimeFormatUtil;
import com.me.hiet.utils.Util;
import com.me.hiet.utils.asset.NvAsset;
import com.me.hiet.utils.permission.PermissionsActivity;
import com.me.hiet.utils.permission.PermissionsChecker;
...
import static com.me.hiet.hite.BaseConstants.CAPTURESCENE_DIALOG_SP_KEY;
import static com.me.hiet.capturescene.data.Constants.CAPTURE_SCENE_LOCAL;
import static com.me.hiet.capturescene.data.Constants.CAPTURE_SCENE_ONLINE;
import static com.me.hiet.capturescene.data.Constants.RESOURCE_NEW_PATH;
...
public class CaptureSceneActivity extends BasePermissionActivity implements NvsAssetPackageManager.AssetPackageManagerCallback, CustomPopWindow.OnViewClickListener,
    ...
    private int getCodeInPermission(String permission) {
        ...
        if (permission.equals(Manifest.permission.CAMERA)) {
            code = MainActivity.REQUEST_CAMERA_PERMISSION_CODE;
        }
        return code;
    }
