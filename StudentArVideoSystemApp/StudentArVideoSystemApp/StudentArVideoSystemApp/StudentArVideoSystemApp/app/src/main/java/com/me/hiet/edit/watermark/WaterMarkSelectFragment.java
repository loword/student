...
import com.me.hiet.hite.BaseFragment;
...
public class WaterMarkSelectFragment extends BaseFragment {
    ...
    protected void initListener() {
        ...
        if (type == WaterMarkConstant.WATERMARKTYPE_STATIC) {
            ...
            imageList.add(new WaterMarkItemData(WaterMarkItemData.ASSETSPICTURE, type, "static_watermark.png", "static_watermark_item.png"));
            ...
            imageList.add(new WaterMarkItemData(WaterMarkItemData.ASSETSPICTURE, type, "banner.caf", "dynamic_watermark.jpg"));
            if (!cafFiles.isEmpty() && !cafJPG.isEmpty()) {
                for (String cafFile : cafFiles) {
                    ...
                    if (checkListContainString(cafJPG, cafFileName + ".jpg")) {
                        imageList.add(new WaterMarkItemData(WaterMarkItemData.SDCARDPICTURE, type, cafFile, cafFileName + ".jpg"));
                    } else if (checkListContainString(cafJPG, cafFileName + ".png")) {
                        imageList.add(new WaterMarkItemData(WaterMarkItemData.SDCARDPICTURE, type, cafFile, cafFileName + ".png"));
                    } else {
                        imageList.add(new WaterMarkItemData(WaterMarkItemData.ASSETSPICTURE, type, cafFile, "default_dynamic_picture.png"));
                    }
                }
            }
        }
    ...
    public void addDataAndRefresh(String picturePath) {
        if (!imageList.contains(new WaterMarkItemData(0, WaterMarkConstant.WATERMARKTYPE_STATIC, picturePath, picturePath))) {
            imageList.add(new WaterMarkItemData(WaterMarkItemData.SDCARDPICTURE, WaterMarkConstant.WATERMARKTYPE_STATIC, picturePath, picturePath));
            cacheList.add(new WaterMarkItemData(WaterMarkItemData.SDCARDPICTURE, WaterMarkConstant.WATERMARKTYPE_STATIC, picturePath, picturePath));
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {//view获取和赋值
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (imageList.get(position).getItemPictureType() == WaterMarkItemData.ASSETSPICTURE) {
        ...
        private void glideLoadPicture(WaterMarkItemData waterMarkItemData, ImageView view) {
            if (waterMarkItemData.getItemPictureType() == WaterMarkItemData.SDCARDPICTURE) {
