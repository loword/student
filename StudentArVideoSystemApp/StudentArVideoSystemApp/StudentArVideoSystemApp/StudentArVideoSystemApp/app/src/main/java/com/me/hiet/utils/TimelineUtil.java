...
import com.me.hiet.edit.watermark.WaterMarkConstant;
import com.me.hiet.edit.watermark.WaterMarkData;
...
public class TimelineUtil {
        ...
        for(int i = 0;i<videoClipCount;i++) {
            ...
            if(mode == FilterItem.FILTERMODE_BUILTIN){//内建特效
                ...
                if(videoClipFxData.getIsCartoon()){
                    fx = clip.appendBuiltinFx("Cartoon");
                    fx.setBooleanVal("Stroke Only", videoClipFxData.getStrokenOnly());
                    fx.setBooleanVal("Grayscale", videoClipFxData.getGrayScale());
                }else {
    ...
    public static void checkAndDeleteExitFX(NvsTimeline mTimeline) {
        ...
        while (nvsTimelineVideoFx != null) {
            ...
            if (name.equals(WaterMarkConstant.WATERMARK_DYNAMICS_FXNAME)){
