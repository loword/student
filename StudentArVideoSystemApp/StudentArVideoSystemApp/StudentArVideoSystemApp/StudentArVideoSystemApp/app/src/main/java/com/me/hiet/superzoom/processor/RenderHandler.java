package com.me.hiet.superzoom.processor;
...
import com.me.hiet.superzoom.base.EGLBase;
...
public final class RenderHandler implements Runnable {
    ...
    public final void draw(long streamTime) {
        draw(mTexId, mMatrix, null, streamTime);
    }

    public final void draw(final int tex_id, long streamTime) {
        draw(tex_id, mMatrix, null, streamTime);
    }

    public final void draw(final float[] tex_matrix, long streamTime) {
        draw(mTexId, tex_matrix, null, streamTime);
    }

    public final void draw(final float[] tex_matrix, final float[] mvp_matrix, long streamTime) {
        draw(mTexId, tex_matrix, mvp_matrix, streamTime);
    }

    public final void draw(final int tex_id, final float[] tex_matrix, long streamTime) {
        draw(tex_id, tex_matrix, null, streamTime);
    }
