package com.me.hiet.capturescene.data;

/**
 * Created by CaoZhiChao on 2019/1/3 16:03
 */
public class Constants {
    private static final String BASEPATH = "http://asset.meishesdk.com:8888/index.php?command=listMaterial&acceptAspectRatio=0&category=0&page=0&pageSize=10&lang=zh_CN&type=";
