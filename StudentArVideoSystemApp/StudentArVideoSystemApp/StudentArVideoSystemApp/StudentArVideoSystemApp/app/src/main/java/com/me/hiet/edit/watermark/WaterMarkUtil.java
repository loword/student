...
public class WaterMarkUtil {
    public static void setWaterMark(NvsTimeline mTimeline, WaterMarkData waterMarkData){
        ...
        if (type == WaterMarkConstant.WATERMARKTYPE_STATIC){
            ...
            String dir = WaterMarkConstant.ASSETS_WATERMARK_PICTURE_PATH;
            if (pictureName.contains(WaterMarkConstant.DEFAULT_WATERMARK_PICTURE)){
    ...
    public static NvsTimelineVideoFx setDynamicWaterMark(NvsTimeline nvsTimeline,int sceneWidth, int sceneHeight, String fileName,
        ...
        int during = 2000;
        NvsTimelineVideoFx story = nvsTimeline.addBuiltinTimelineVideoFx(0, nvsTimeline.getDuration(), WaterMarkConstant.WATERMARK_DYNAMICS_FXNAME);
