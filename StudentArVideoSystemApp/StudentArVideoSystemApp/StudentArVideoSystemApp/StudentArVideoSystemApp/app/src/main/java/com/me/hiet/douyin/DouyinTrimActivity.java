...
import com.me.hiet.edit.clipEdit.SingleClipFragment;
...
public class DouyinTrimActivity extends BasePermissionActivity {
    ...
    static class DouyinTrimHandler extends Handler
    {
        ...
        public DouyinTrimHandler(DouyinTrimActivity activity)
        {
        ...
        {
            final DouyinTrimActivity activity = mWeakReference.get();
            if(activity != null)
            {
                switch (msg.what) {
                    case VIDEOPLAYTOEOF:
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.trimFinish:
                ...
                AppManager.getInstance().jumpActivity(DouyinTrimActivity.this, DouYinEditActivity.class, bundle);
                break;
    ...
    private void loadVideoClipFailTips(){
        ...
        Util.showDialog(DouyinTrimActivity.this, versionName[0], versionName[1], new TipsButtonClickListener() {
            @Override
