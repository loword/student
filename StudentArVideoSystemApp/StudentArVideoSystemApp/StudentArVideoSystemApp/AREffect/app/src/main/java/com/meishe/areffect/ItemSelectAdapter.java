...
public class ItemSelectAdapter extends RecyclerView.Adapter<ItemSelectAdapter.ItemViewHolder>{
    ...
    public static final int[] Daoju_RES_ARRAY = {
        R.mipmap.ic_delete_all, R.mipmap.tuzimaoxin, R.mipmap.xiangsuhuaxin, R.mipmap.mkblyanjing, R.mipmap.mjdjlz,
            R.mipmap.wuliannan, R.mipmap.lizituzierduo, R.mipmap.zhanliyanjing, R.mipmap.huahuan, R.mipmap.chaojimali,
            R.mipmap.kejiyanjing, R.mipmap.shouwangxianfeng, R.mipmap.lanseyu, R.mipmap.changjinglu, R.mipmap.longzhu, R.mipmap.xuanyunyanjing,
            R.mipmap.maoerduo, R.mipmap.meiguomianju, R.mipmap.leisheyanjing,
            R.mipmap.yanjingjiguang, R.mipmap.yiqunmao, R.mipmap.mojingkulou, R.mipmap.xiaoxiongerduo, R.mipmap.yun, R.mipmap.maozikouzhao
    };
    ...
    public static ArrayList CAPTURESCENE_NAME = new ArrayList();
    ...
    private List<String> m_daojuPicturesFromSD = new ArrayList<>();
    ...
    public int getItemCount() {
        return mOwnerRecyclerViewType == RECYCLEVIEW_TYPE_EFFECT ?
                CAPTURESCENE_NAME.size() :
                FILTERS_NAME.size();
    }

    public void setDaojuPicFromSD(List<String> pic_list) {
        m_daojuPicturesFromSD = pic_list;
    }
    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        if (mOwnerRecyclerViewType == RECYCLEVIEW_TYPE_EFFECT) {
            if(position >= Daoju_RES_ARRAY.length) {
                holder.mItemView.setItemIcon(R.mipmap.fresh);
            } else {
