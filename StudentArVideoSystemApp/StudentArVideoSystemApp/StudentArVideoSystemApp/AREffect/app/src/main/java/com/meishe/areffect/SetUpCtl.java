...
import com.meishe.areffect.beauty_shape.BeautyShapeAdapter;
import com.meishe.areffect.beauty_shape.BeautyShapeListItem;
...
public class SetUpCtl extends LinearLayout {
    ...
    private String m_currentBeautyShapeValue;
    ...
    public void resetData(){
        ...
        m_resetBeautyShapeBtn.callOnClick();
    }
    ...
    private void initListener(){
        ...
        m_resetBeautyShapeBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                m_beautyShapeSeekbar.setProgress(100);
                if(m_listener != null){
                    m_listener.onBeautyShapeValue(m_currentBeautyShapeType, m_currentBeautyShapeValue, 100, m_beautyShapeSeekbar.getMax());
                }
            }
        });
        ...
        m_beautyShapeSeekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                if(str.equals(m_currentBeautyShapeValue)) {
                ...
                if(b) {
                    if(m_listener != null){
                        m_listener.onBeautyShapeValue(m_currentBeautyShapeType, m_currentBeautyShapeValue, i, m_beautyShapeSeekbar.getMax());
                    }
                }
            }
    ...
    public void setCaptureSceneData(ArrayList list){
        ItemSelectAdapter.CAPTURESCENE_NAME = list;
        initStickerList();
    }
    ...
    private void initStickerList(){
        ...
        m_DaojuRecyclerAdapter.setOnItemSelectedListener(new ItemSelectAdapter.OnItemSelectedListener() {
            ...
            public void onItemSelected(int itemPosition) {
                ...
                if(m_listener != null) {
                    m_listener.onDaojuItemSelected(ItemSelectAdapter.CAPTURESCENE_NAME.get(itemPosition).toString());
                }
            }
        });
        ...
        if (m_beautyShapeTypeAdapter == null) {
            ...
            m_beautyShapeTypeAdapter.setOnItemClickListener(new BeautyShapeAdapter.OnItemClickListener() {
                ...
                public void fxSelected(int pos, BeautyShapeListItem audioFxListItem) {
                    switch (pos) {
                        case 0: // 瘦脸
                            m_currentBeautyShapeType = "Has Shrink Face";
                            m_currentBeautyShapeValue = "Shrink Face Ratio";
                            break;
                        case 1: // 大眼
                            m_currentBeautyShapeType = "Has Eye Enlarge";
                            m_currentBeautyShapeValue = "Eye Enlarge Ratio";
                            break;
                        case 2: // 下巴
                            m_currentBeautyShapeType = "Has Chin Warp";
                            m_currentBeautyShapeValue = "Chin Warp Ratio";
                            break;
                        case 3: // 小脸
                            m_currentBeautyShapeType = "Has Face Length Warp";
                            m_currentBeautyShapeValue = "Face Length Warp Ratio";
                            break;
                        case 4: // 窄脸
                            m_currentBeautyShapeType = "Has Face Width Warp";
                            m_currentBeautyShapeValue = "Face Width Warp Ratio";
                            break;
                        case 5: // 额头
                            m_currentBeautyShapeType = "Has Forehead Warp";
                            m_currentBeautyShapeValue = "Forehead Warp Ratio";
                            break;
                        case 6: // 瘦鼻
                            m_currentBeautyShapeType = "Has Nose Width Warp";
                            m_currentBeautyShapeValue = "Nose Width Warp Ratio";
                            break;
                        case 7: // 长鼻
                            m_currentBeautyShapeType = "Has Nose Length Warp";
                            m_currentBeautyShapeValue = "Nose Length Warp Ratio";
                            break;
                        case 8: // 眼角
                            m_currentBeautyShapeType = "Has Eye Corner Stretch";
                            m_currentBeautyShapeValue = "Eye Corner Stretch Ratio";
                            break;
                        case 9: // 嘴形
                            m_currentBeautyShapeType = "Has Mouth Size Warp";
                            m_currentBeautyShapeValue = "Mouth Size Warp Ratio";
                            break;
                        case 10: // 嘴角
                            m_currentBeautyShapeType = "Has Mouth Corner Lift";
                            m_currentBeautyShapeValue = "Mouth Corner Lift Ratio";
                            break;
                    }
                    if(m_listener != null) {
                        m_listener.onBeautyShapeSelected(m_currentBeautyShapeType, m_currentBeautyShapeValue);
                    }
                }
            });
        }
    ...
    public interface SetUpCtlListener{
        ...
        // 美型强度
        void onBeautyShapeSelected(String beauty_shape_type, String beauty_shape_value);
        void onBeautyShapeValue(String beauty_shape_type, String beauty_shape_value, int progress, int max);
        // 重置
