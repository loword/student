package com.netease.nim.student.session;
...
import com.netease.nim.student.contact.activity.RobotProfileActivity;
import com.netease.nim.student.contact.activity.UserProfileActivity;
import com.netease.nim.student.redpacket.NIMRedPacketClient;
import com.netease.nim.student.session.action.AVChatAction;
import com.netease.nim.student.session.action.AckMessageAction;
import com.netease.nim.student.session.action.FileAction;
import com.netease.nim.student.session.action.GuessAction;
import com.netease.nim.student.session.action.RTSAction;
import com.netease.nim.student.session.action.RedPacketAction;
import com.netease.nim.student.session.action.SnapChatAction;
import com.netease.nim.student.session.action.TeamAVChatAction;
import com.netease.nim.student.session.action.TipAction;
import com.netease.nim.student.session.activity.AckMsgInfoActivity;
import com.netease.nim.student.session.activity.MessageHistoryActivity;
import com.netease.nim.student.session.activity.MessageInfoActivity;
import com.netease.nim.student.session.extension.CustomAttachParser;
import com.netease.nim.student.session.extension.CustomAttachment;
import com.netease.nim.student.session.extension.GuessAttachment;
import com.netease.nim.student.session.extension.RTSAttachment;
import com.netease.nim.student.session.extension.RedPacketAttachment;
import com.netease.nim.student.session.extension.RedPacketOpenedAttachment;
import com.netease.nim.student.session.extension.SnapChatAttachment;
import com.netease.nim.student.session.extension.StickerAttachment;
import com.netease.nim.student.session.search.SearchMessageActivity;
import com.netease.nim.student.session.viewholder.MsgViewHolderAVChat;
import com.netease.nim.student.session.viewholder.MsgViewHolderDefCustom;
import com.netease.nim.student.session.viewholder.MsgViewHolderFile;
import com.netease.nim.student.session.viewholder.MsgViewHolderGuess;
import com.netease.nim.student.session.viewholder.MsgViewHolderOpenRedPacket;
import com.netease.nim.student.session.viewholder.MsgViewHolderRTS;
import com.netease.nim.student.session.viewholder.MsgViewHolderRedPacket;
import com.netease.nim.student.session.viewholder.MsgViewHolderSnapChat;
import com.netease.nim.student.session.viewholder.MsgViewHolderSticker;
import com.netease.nim.student.session.viewholder.MsgViewHolderTip;
